...
foreach($advance_search as $each)
{
    ...
    {                       
        ...
        { 
                            // dd($each);
                            // exit();
            if($user_data['complexion'] == $each['complexion'] || $user_data['marital_status'] == $each['marital_status'] || $user_data['children'] == $each['children']
            || $user_data['mother_tongue'] == $each['mother_tongue'] || $user_data['family_value'] == $each['family_value'] || $user_data['district'] == $each['district'] 
            || $user_data['profession'] == $each['profession'] || $user_data['location'] == $each['location'])
            {       
?>
